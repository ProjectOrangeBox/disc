...
final class directoryTest extends TestCase
{
	...
	{
			/* copy part */;
		$this->assertInstanceOf(\dmyers\disc\Directory::class, $newDir = disc::directory('/files')->copy('/working/foobar'));
	...
	{
		/* copy part */
		$this->assertInstanceOf(\dmyers\disc\Directory::class, $newDir = disc::directory('/files')->copy('/working/foo'));
		$this->assertTrue($newDir->exists());

		$this->assertInstanceOf(\dmyers\disc\Directory::class, $newDir->rename('bar'));
		...
		$this->assertInstanceOf(\dmyers\disc\Directory::class, $newDir->rename('/foo/bar'));
	}
	...
	public function testMove(): void
	{
		...
		$this->assertInstanceOf(\dmyers\disc\Directory::class, $newDir->move('/working/new/folder/here'));
		$this->assertTrue($newDir->exists());
	...
	{
		$this->assertInstanceOf(\dmyers\disc\Directory::class, disc::directory('/files'));
	}
	...
	{
		$this->assertEquals(16877, disc::directory('/files')->permissions());
		$this->assertEquals('d', disc::directory('/files')->permissions(1));
		$this->assertEquals('rwxr-xr-x', disc::directory('/files')->permissions(2));
		$this->assertEquals('drwxr-xr-x', disc::directory('/files')->permissions(3));
	}
} /* end class */
